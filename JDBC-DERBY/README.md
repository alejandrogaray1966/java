...
- [x] Gestión de entidades (Productos, Compras, etc.) conectadas a una base de datos **DERBY**.
...
Se centra en la implementación de un **sistema CRUD** para la gestión de productos y compras usando **Java, JDBC y DERBY**.  
